...
<?php
	...
	if(empty($idLote))
	{echo "<p> *Error, completar el Código del Lote </p>";
	$valido = 0;
	}
	...
	$sentencia = "INSERT INTO logentrada_pt VALUES ('$ID', null,'$idLote','$Cantidad','$Unidad','$Fecha_entrada','$Hora_entrada','$Fecha_vencimiento','$Temperatura_ref') ;";
