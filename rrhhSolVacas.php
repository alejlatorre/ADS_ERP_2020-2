                        ...
                        <center>
                            ...
                            <p>
                                <form action="" method="POST">
                                    ...
                                    Posición: <input type="text" name="posicion"><br><br>
                                    Fecha de inicio: <input type="date" name="f_inicio"><br><br>
									Fecha de fin: <input type="date" name="f_fin"><br><br>
                                    <br>
                                    <input type="submit" value="Solicitar" formaction="rrhhSolVacas2.php">
                                    <input type="submit" value="Regresar" formaction="vistaPrincipal.php">                                    
                                </form>
                            </p>
                        </center>
                    </div>
