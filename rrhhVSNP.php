        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <center>
                        <h1>Solicitudes Generadas de Nuevas Posiciones</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php
                                        ...
                                        $sentencia = "SELECT * FROM rrhhsolnp;";                            
                                        ...
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<td>N°Requerimiento</td>";
                                        echo "<td>Gerencia</td>";
                                        echo "<td>Area</td>";
                                        echo "<td>Cantidad de Vacantes</td>";
                                        echo "<td>Posición Solicitada</td>";
                                        echo "<td>Código del Solicitante</td>";
										echo "</tr>";
                                        echo "</thead>";
                                        echo "<tbody>";
