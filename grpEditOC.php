                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php
                                        ...
                                        $sentencia = "SELECT * FROM grpnuevasoc WHERE OC = '$OC';";                   
                                        ...
                                        echo "Fecha de creación de la OC: <input type='date' name='FechaCrea_OC' value='",$registro[7],"'><br><br>"; 
                                        echo "<input type='submit' value='Guardar' formaction='grpEditarOC.php'>";
                                        echo "</form>";
                                    ?>                                
                                </div>
                            </div>
