        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <center>
                        <h1>Stock de Ingredientes en el almacén</h1>
                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php
                                        ...
                                        $sentencia = "SELECT  i.nomMP, SUM(e.Cantidad), e.Unidad 
                                            FROM logentrada_mp AS e
                                            INNER JOIN loginput as i
                                            on e.codMP = i.codMP
                                            GROUP BY e.codMP, e.Unidad ;";                            
                                        ...
                                        echo "<thead>";
                                        echo "<tr>";
                                        echo "<td>Nombre de Ingrediente</td>";
                                        echo "<td>Cantidad</td>";
                                        echo "<td>Unidad</td>";
                                        echo "</tr>";
                                        echo "</thead>";
