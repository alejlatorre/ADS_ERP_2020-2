                            ...
                            <div class="card-body">
                                <div class="table-responsive">
                                    <?php
                                        ...
                                        $sentencia = "SELECT  a.codLinea, a.Tipo, a.nomMaquina, a.Capacidad, a.Unidad, b.nomPT  
                                            FROM prodmaquina as a
                                        ...
                                        echo "<td>Tipo de Maquinaria</td>";
                                        echo "<td>Nombre de la Máquina</td>";
										echo "<td>Capacidad</td>";
										echo "<td>Unidades</td>";
										echo "<td>Nombre del producto asignado</td>";
										echo "</tr>";
                                        echo "</thead>";
