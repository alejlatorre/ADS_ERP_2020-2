                    ...
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form action="rrhhTrabajadores.php" method="POST">
                                    <?php
                                    $idPersonal = $_POST["codTrabajador"];
                                    $conexion = mysqli_connect("localhost","root","","bd_erp");
                                    $sentencia = "SELECT pers.nomPersonal, pers.apellidoPersonal, pos.nomPosicion, jef.nomPersonal as nomJefe, pers.fechaIngreso
                                                    FROM rrhhpersonal pers
                                                    LEFT JOIN 
                                                    rrhhposicion pos 
                                                    ON 
                                                    pers.idPosicion = pos.idPosicion
                                                    LEFT JOIN 
                                                    (SELECT idPersonal, nomPersonal
                                                    FROM rrhhpersonal) jef
                                                    ON 
                                                    pers.idJefe = jef.idPersonal
                                                    WHERE 
                                                    pers.idPersonal = '".$idPersonal."';";                   
