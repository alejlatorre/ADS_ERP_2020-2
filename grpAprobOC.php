        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <center>
                        <h1 class="mt-4">Aprobación de Orden de Compra</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
									...
									echo "<td>Aprobacion legal</td>";
									echo "<td>Aprobacion finanzas</td>";
                                    echo "<td>Acciones</td>";
                                    echo "</tr>";
                                    echo "<thead>";
                                    ...
                                    while ($i <= $numFilas)
                                    {
                                        ...
                                        echo "<td><a href='grpEditAprobOC.php?Concepto=$registro[1]'>Editar</a> <a href='grpEliminarAprobOC.php?Concepto=$registro[1]'>Eliminar</a></td>";
                                        echo "</tr>";
                                        $i = $i + 1; 
                                    }
                                    echo "</tbody>";
