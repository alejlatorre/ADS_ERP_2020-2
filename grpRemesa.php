        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <center>
                        <h1 class="mt-4">Registro de Remesas Bancarias</h1>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                ...
                                <form action="grpNuevaRemesa.php" method="POST">
                                    <?php
                                    $conexion = mysqli_connect("localhost","root","","bd_erp");
                                    $sentencia = "SELECT * FROM grpremesas;";                   
                                    ...
                                    echo "<td>Nombre de remesa</td>";
                                    echo "<td>Ordenante</td>";
                                    echo "<td>RUC</td>";
                                    echo "<td>Concepto de la factura</td>";
                                    ...
                                    while ($i <= $numFilas)
                                    {
                                        ...
                                        echo "<td> <a href='grpEliminarRemesa.php?numFactura=$registro[1]'>Eliminar</a></td>";
                                        echo "</tr>";
                                        $i = $i + 1; 
                                    }
                                    echo "</tbody>";
                                    ...
                                    <p>
                                        <input type="submit" value="Añadir Remesa Bancaria">
                                    </p>
